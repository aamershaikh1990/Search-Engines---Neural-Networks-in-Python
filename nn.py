...
class searchnet:
	...
	def maketables(self):
		...
		# Get strength of a connection between neural network layers
	...
	# Set the strength of a connection between neural network layers
	...
	def generatehiddennode(self,wordids,urls):
		...
		#Get the hidden node ids for a set of input words and output urls
	...
	#Method to get the wordids and urlids to setup the neural network
	def getresult(self,wordids,urlids):
		self.setupnetwork(wordids,urlids)
		return self.feedforward()

	#Code fo the backpropagation algorithm to train the network based on actual and calculated output
	...
	def trainquery(self,wordids,urlids,selectedurl):
		#generate a hidden node if ncessary
